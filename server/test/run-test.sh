...
export PATH=../src/.libs:../hfl/src/.libs:$PATH
export LD_LIBRARY_PATH=../src/.libs:../common/.libs:../hfl/src/.libs:$LD_LIBRARY_PATH

export HATOHOL_ACTION_LD_LIBRARY_PATH=../src/.libs:../common/.libs:../hfl/src/.libs
