...
#define OBSOLETED_MONITORING_SYSTEM_HAPI_ZABBIX MONITORING_SYSTEM_HAPI_ZABBIX
#define OBSOLETED_MONITORING_SYSTEM_HAPI_NAGIOS MONITORING_SYSTEM_HAPI_NAGIOS
#define OBSOLETED_MONITORING_SYSTEM_HAPI_CEILOMETER MONITORING_SYSTEM_HAPI_CEILOMETER
