...
class Common:
    ...
    def collect_hosts_and_put(self):
        self.put_procedure(self.put_hosts, self.__collect_hosts())
    ...
    def collect_items_and_put(self, fetch_id, host_ids):
        ...
        self.put_procedure(self.put_items, items, fetch_id)
    ...
    def collect_history_and_put(self, fetch_id, host_id, item_id,
        ...
        self.put_procedure(self.put_history, sorted_samples, item_id, fetch_id)
    ...
    def __collect_events_and_put(self, alarm_id, last_alarm_time, fetch_id):
        ...
        self.put_procedure(self.put_events, sorted_events, fetch_id=fetch_id,
