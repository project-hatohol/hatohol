...
class BaseMainPlugin(unittest.TestCase):
    ...
    def test_hap_notifier_monitoring_server_info(self):
        ...
        common.assertNotRaises(self.__main_plugin.hap_notify_monitoring_server_info,
                               test_params)
    ...
    def test_detect_implemented_procedures(self):
        ...
        self.assertEquals({"exchangeProfile": self.__main_plugin.hap_exchange_profile,
                           "notifyMonitoringServerInfo": self.__main_plugin.hap_notify_monitoring_server_info},
