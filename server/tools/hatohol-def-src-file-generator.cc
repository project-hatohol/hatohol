...
static void makeDefSourceValues(string &s, LanguageType langType)
{
	...
	ADD_LINE(s, langType, OPPRVLG_CREATE_CUSTOM_INCIDENT_STATUS);
	ADD_LINE(s, langType, OPPRVLG_UPDATE_CUSTOM_INCIDENT_STATUS);
	ADD_LINE(s, langType, OPPRVLG_DELETE_CUSTOM_INCIDENT_STATUS);
