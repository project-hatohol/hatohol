...
enum {
	IDX_FUNCTIONS_RAW_2_0_GENERATION_ID,
...
enum {
  ...
  IDX_ITEM_RAW_2_0_ITEMID,
  IDX_ITEM_RAW_2_0_TYPE,
  IDX_ITEM_RAW_2_0_SNMP_COMMUNITY,
  IDX_ITEM_RAW_2_0_SNMP_OID,
  IDX_ITEM_RAW_2_0_HOSTID,
  IDX_ITEM_RAW_2_0_NAME,
  IDX_ITEM_RAW_2_0_KEY_,
  IDX_ITEM_RAW_2_0_DELAY,
  IDX_ITEM_RAW_2_0_HISTORY,
  IDX_ITEM_RAW_2_0_TRENDS,
  IDX_ITEM_RAW_2_0_LASTVALUE,
  IDX_ITEM_RAW_2_0_LASTCLOCK,
  IDX_ITEM_RAW_2_0_PREVVALUE,
  IDX_ITEM_RAW_2_0_STATUS,
  IDX_ITEM_RAW_2_0_VALUE_TYPE,
  IDX_ITEM_RAW_2_0_TRAPPER_HOSTS,
  IDX_ITEM_RAW_2_0_UNITS,
  IDX_ITEM_RAW_2_0_MULTIPLIER,
  IDX_ITEM_RAW_2_0_DELTA,
  IDX_ITEM_RAW_2_0_PREVORGVALUE,
  IDX_ITEM_RAW_2_0_SNMPV3_SECURITYNAME,
  IDX_ITEM_RAW_2_0_SNMPV3_SECURITYLEVEL,
  IDX_ITEM_RAW_2_0_SNMPV3_AUTHPASSPHRASE,
  IDX_ITEM_RAW_2_0_SNMPV3_PRIVPASSPHRASE,
  IDX_ITEM_RAW_2_0_FORMULA,
  IDX_ITEM_RAW_2_0_ERROR,
  IDX_ITEM_RAW_2_0_LASTLOGSIZE,
  IDX_ITEM_RAW_2_0_LOGTIMEFMT,
  IDX_ITEM_RAW_2_0_TEMPLATEID,
  IDX_ITEM_RAW_2_0_VALUEMAPID,
  IDX_ITEM_RAW_2_0_DELAY_FLEX,
  IDX_ITEM_RAW_2_0_PARAMS,
  IDX_ITEM_RAW_2_0_IPMI_SENSOR,
  IDX_ITEM_RAW_2_0_DATA_TYPE,
  IDX_ITEM_RAW_2_0_AUTHTYPE,
  IDX_ITEM_RAW_2_0_USERNAME,
  IDX_ITEM_RAW_2_0_PASSWORD,
  IDX_ITEM_RAW_2_0_PUBLICKEY,
  IDX_ITEM_RAW_2_0_PRIVATEKEY,
  IDX_ITEM_RAW_2_0_MTIME,
  IDX_ITEM_RAW_2_0_LASTNS,
  IDX_ITEM_RAW_2_0_FLAGS,
  IDX_ITEM_RAW_2_0_FILTER,
  IDX_ITEM_RAW_2_0_INTERFACEID,
  IDX_ITEM_RAW_2_0_PORT,
  IDX_ITEM_RAW_2_0_DESCRIPTION,
  IDX_ITEM_RAW_2_0_INVENTORY_LINK,
  IDX_ITEM_RAW_2_0_LIFETIME,
  NUM_IDX_ITEM_RAW_2_0,
};
...
void DBClientZabbix::init(void)
{
	...
	ASURA_ASSERT(
	  NUM_COLUMNS_ITEMS_RAW_2_0 == NUM_IDX_ITEM_RAW_2_0,
	  "Invalid number of elements: NUM_COLUMNS_ITEMS_RAW_2_0 (%zd), "
	  "NUM_IDX_ITEM_RAW_2_0 (%zd)",
	  NUM_COLUMNS_ITEMS_RAW_2_0, NUM_IDX_ITEM_RAW_2_0);
}
