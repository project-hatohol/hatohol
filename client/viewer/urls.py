...
urlpatterns = patterns('',
    ...
    url(r'^ajax_log_search_systems$', TemplateView.as_view(template_name='viewer/log_search_systems_ajax.html')),
    ...
    url(r'^ajax_history$', TemplateView.as_view(template_name='viewer/history_ajax.html')),
)
